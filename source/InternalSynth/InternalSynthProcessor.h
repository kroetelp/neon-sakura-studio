...
/**
 * InternalSynthProcessor - Native Internal Synthesizer for Neon Sakura Studio DAW
 *
 * This is NOT a VST plugin - it's the built-in synthesizer that ships with
 * the DAW. It wraps the WavetableEngine and provides:
 *   - Parameter automation via DAW timeline
 *   - MIDI input from DAW tracks
 *   - Audio output to DAW mixer
 *
 * Architecture:
 *   InternalSynthProcessor -> WavetableEngine -> WavetableSynth -> Voices
 */
class InternalSynthProcessor : public juce::AudioProcessor
{
public:
    InternalSynthProcessor();
    ~InternalSynthProcessor() override;

    // ============================================================
    // JUCE AudioProcessor API (for integration with DAW's AudioProcessorGraph)
    // ============================================================
    ...
    // Editor creation (for internal UI panel)
    ...
    const juce::String getName() const override { return "Internal Wavetable Synth"; }
    ...
    // ============================================================
    // Direct Engine Access (for DAW UI panels)
    // ============================================================
    ...
    // ============================================================
    // Parameter Access (for DAW automation)
    // ============================================================
...
private:
    // ============================================================
    // Audio Engine - WavetableEngine for synthesis
    // ============================================================
